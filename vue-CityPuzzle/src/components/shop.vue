            ...
            <div class="col-xl-9 col-md-12 col-sm-12">
                <div v-for="questGroup in filteredQuests" :key="questGroup.questType">
                    ...
                    <div class="quest-group">
                        <QuestCard v-for="quest in questGroup.quests" :key="quest.id" :quest="quest" :parseCategory="parseCategory" :purchaseQuest="purchaseQuest" />
                    </div>
                </div>
            </div>
        </div>
...
const QuestCard = defineAsyncComponent(() => import('../components/questCard.vue'));
